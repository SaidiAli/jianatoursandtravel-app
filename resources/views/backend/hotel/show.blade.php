        ...
        <div class="card mb-4 mb-xl-0">
            <div class="container">
                ...
                <div class="card-body">
                    ...
                    <form id="booking_form" action="{{route('booking.store')}}" class="needs-validation" novalidate
                          method="POST">
                        @csrf
                        <div class="p-4 my-3">
                            <div class="form-group row">
                                <div class="col-7 col-md-4">
                                    ...
                                    <input class="form-control-sm form-control" id="checkin-date" type="date" required
                                           name="check_in_date" required>
                                </div>
                                <div class="col-5 col-md-3">
                                    <label for="checkin-time">Time</label>
                                    <input class="form-control-sm form-control" id="checkin-time" type="time" required
                            ...
                            <div class="form-group row">
                                <div class="col-7 col-md-4">
                                    ...
                                    <input class="form-control-sm form-control" id="checkout-date" type="date" required
                                           name="check_out_date" required>
                                </div>
                                <div class="col-5 col-md-3">
                                    <label for="checkout-time">Time</label>
                                    <input class="form-control-sm form-control" id="checkout-time" type="time" required
                            ...
                            <div class="form-group row">
                                <div class="col-6 col-md-3">
                                    ...
                                    <input class="form-control-sm form-control" id="adults" type="number" name="adults"
                                           value="1" min="0">
                                </div>
                                <div class="col-6 col-md-3">
                                    <label for="children">Children</label>
                                    <input class="form-control-sm form-control" id="children" type="number"
                                           name="children" value="0" min="0">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-5">
                                            <div class="card-body">
                                                ...
                                                <p class="room-price">UGX {{$room->price}}/<span class="pn">per night</span></p>
                                                <p>Bed: <span class="card-text text-muted">King Size</span></p>
                                                <p>Services: <span class="card-text text-muted">24/7 room service, WI-FI, TV, PS</span>
                                                </p>
                                                <a class="btn btn-success" href="javascript: void(0);"
                                                   id="booking-btn-{{$room->id}}">Book Now</a>
                                                <input class="form-control room-select hotel-room  d-none"
                                                       id="input-{{$room->id}}" type="number" name="rooms" required
                                                       value="1" min="0">
                                                <p class="card-text"><small
                                                        class="text-muted">Status: @if ($room->is_bookable == true)
                        ...
                        <div class="row justify-content-center my-3">
                            <div class="col-lg-8">
                                <p class="selected-items text-center d-none"><span id="number_of_rooms">0</span> rooms
                                    <span id="number_of_adults">1</span> adult <span id="number_of_children">0</span>
                                    children</p>
            ...
            <div class="row justify-content-around">
                <div class="card col-lg-5 mr-1">
                    <div class="row no-gutters align-items-center">
                        <div class="col-md-5">
                            <img src="{{asset('images/portfolio/thumbnails/1.jpg')}}" class="card-img img-fluid"
                        ...
                        <div class="col-md-7">
                            <div class="card-body">
                                ...
                                <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat,
                                    aut velit beatae veritatis, ipsam sequi, laudantium hic tempore cupiditate alias
                                    provident cum explicabo sit obcaecati id ex earum enim quidem.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card col-lg-5">
                    <div class="row no-gutters align-items-center">
                        <div class="col-md-5">
                            <img src="{{asset('images/portfolio/thumbnails/2.jpg')}}" class="card-img"
                                 alt="hotel room picture">
                        </div>
                        <div class="col-md-7">
                            <div class="card-body">
